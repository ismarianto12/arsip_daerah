...
<div class="demo-form-wrapper">
    <form class="form form-horizontal" id="simpan">
        <div class="form-group">
            <label class="col-sm-3 control-label" for="form-control-1">Nama Satuan</label>
            <div class="col-sm-6">
                <input id="form-control-1" class="form-control" type="text" name="nama_satuan">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label" for="form-control-1">Keterangaan</label>
            <div class="col-sm-6">
...
<script>
    $(function() {
        ...
        $('#simpan').submit(function(e) {
            e.preventDefault();
            if ($('input[name="nama_satuan"]').val() == '') {
                toastr.error('<i class="fa fa-close"></i>Nana satuan tidak boleh kosong');
            } else {
