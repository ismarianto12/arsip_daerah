...
@section('content')
    ...
    <script>
        ...
        $('#tambah').click(function(e) {
            e.preventDefault();
            $('.formcontent').html('Loading ..').load('{{ route('jabatan.create') }}').slideDown();
        });

        $('#datatable').on('click', '#edit', function(e) {
            e.preventDefault();
            var edit_id = $(this).data('id');
            var urledit = '{{ route('jabatan.edit', ':id') }}'.replace(':id', edit_id);
        ...
        $('#datatable').on('click', '#delete', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // alert(data);
                    $.ajax({
                        url: '{{ route('jabatan.destroy', ':id') }}'.replace(':id', data_id),
                        data: {
                            id: data_id,
                        },
                        chace: false,
