Tambah data lokasi arsip
<hr />
<div class="demo-form-wrapper">
    <form class="form form-horizontal" id="simpan">
        <div class="form-group">
            <label class="col-sm-3 control-label" for="form-control-1">Lokasii</label>
            <div class="col-sm-6">
                <input id="form-control-1" class="form-control" type="text" name="nama_lokasi">
            </div>
        </div>
...
<script>
    $(function() {
        ...
        $('#simpan').submit(function(e) {
            e.preventDefault();
            if ($('input[name="nama_lokasi"]').val() == '') {
                toastr.error('<i class="fa fa-close"></i>Nana lokasi tidak boleh kosong');
            } else {
