...
<div class="demo-form-wrapper">
    <form class="form form-horizontal" id="simpan">
        <div class="form-group">
            <label class="col-sm-3 control-label" for="form-control-1">Nama jenis</label>
            <div class="col-sm-6">
                <input id="form-control-1" class="form-control" type="text" name="nama">
            </div>
        </div>
